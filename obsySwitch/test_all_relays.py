...
def test_all_relays():
    ...
    try:
        ...
        # Get initial status
        print("1£ Getting initial status of all relays...")
        ...
        print(f"\n2£ Testing each relay individually...")
        print(f"   Listen carefully for click sounds from each relay!")
        ...
        print(f"\n3£ Testing all relays together...")
        print(f"  This will turn ON all relays in sequence, then OFF")
        
        # Turn all ON in sequence
        print(f"  Turning all relays ON...")
        ...
        print(f"  Emergency stop - turning all OFF...")
        ...
        print(f"  Power: VCC  Arduino 5V, GND  Arduino GND")
        print(f"  Signals:")
        print(f"     IN1  Arduino Pin 2 (Relay 1 - Mount)")
        print(f"     IN2  Arduino Pin 3 (Relay 2 - Camera)")  
        print(f"     IN3  Arduino Pin 4 (Relay 3 - Focuser)")
        print(f"     IN4  Arduino Pin 5 (Relay 4 - Aux)")
        
        print(f"\n If any relays aren't clicking:")
        print(f" 1. Check signal wire connections")
        print(f" 2. Verify relay module power")
        print(f" 3. Look for LED indicators on relay module")
        print(f" 4. Some modules need external 5V supply")
        print(f" 5. Check if jumper caps are properly positioned")
...
if __name__ == "__main__":
    print(f"ObsyBox 4-Relay Test Suite")
    print("=" * 40)
